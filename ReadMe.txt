...
Este é um bot simples em Python que monitora o preço de um produto em um link de um site de compras. Quando o preço cai abaixo de um valor definido, ele envia uma notificação automática via Telegram.
